...
/// Skipper incident / protest form — type, boats involved, GPS auto-capture,
/// description, optional rules, send to RC.
class SkipperIncidentScreen extends ConsumerStatefulWidget {
  const SkipperIncidentScreen({super.key});

  @override
  ConsumerState<SkipperIncidentScreen> createState() =>
      _SkipperIncidentScreenState();
}

class _SkipperIncidentScreenState
    extends ConsumerState<SkipperIncidentScreen> {
  final _descCtrl = TextEditingController();
  final _otherSailCtrl = TextEditingController();

  String _type = 'protest'; // protest | incident | note
    ...
    return ListView(
      ...
      children: [
        ...
        SegmentedButton<String>(
          segments: const [
            ButtonSegment(value: 'protest', label: Text('Protest'), icon: Icon(Icons.gavel)),
            ButtonSegment(value: 'incident', label: Text('Incident'), icon: Icon(Icons.warning)),
            ButtonSegment(value: 'note', label: Text('Note'), icon: Icon(Icons.note)),
          ],
          selected: {_type},
